...
export const ErrorState: React.FC<ErrorStateProps> = ({ error, onRetry }) => {
  ...
  return (
    <div className="text-center py-12 animate-fade-in">
      ...
      <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Wystąpił błąd</h3>

      <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-md mx-auto">{getErrorMessage(error)}</p>
