...
- Kryteria akceptacji:
  ...
  - Po pomyślnej rejestracji, jestem automatycznie zalogowany i przekierowany do głównego widoku aplikacji (listy samochodów).
...
- Kryteria akceptacji:
  ...
  - Uzytkownik nie moze korzystac z aplikacji, jesli nie jest zalogowany.
  - Kazda strona oraz endpoint API musza byc zabezpieczone i wymagac sesji zalogowanego uzytkownika
  - Nie korzystamy z zewnętrznych serwisów logowania (np. Google, Facebook)
...
- Kryteria akceptacji:
  - W interfejsie aplikacji znajduje się wyraźnie oznaczony przycisk "Wyloguj". Przycisk znajduje sie po prawej u gory.
